...
export default function PlasticPalletsPage() {
  return <>
    <section className="catalog-detail-hero texture-grid">
      ...
      <div className="catalog-detail-image-slot catalog-hero-photo" style={{ backgroundImage: `url('${getProductImage("plastic-pallets", "plastic-pallets")}')` }} aria-label="Plastic pallets image"><div className="catalog-hero-photo-overlay"/><div className="catalog-hero-photo-meta"><span>PLASTIC PALLETS</span><b>STATIC PRODUCT VIEW</b></div></div>
    </section>
